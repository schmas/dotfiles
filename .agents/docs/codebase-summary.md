...
| Apply-time fetched artifacts (none declared today) | `.chezmoiexternal.toml` |
| `upall` install (once, then self-updating) | `.chezmoiscripts/01-common/run_once_after_05.5-upall-install.sh.tmpl` |
